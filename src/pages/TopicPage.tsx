    ...
    >
      ...
      <div className="topic-content">
        <header className="topic-header">
          ...
          {topic.slug === "korean" && (
            <span className="topic-subtitle-hangul">한국어</span>
          )}
          {topic.slug === "coding" && (
            <span className="topic-subtitle-code">{"</>"}</span>
          )}
          {topic.slug === "toki-pona" && (
            <span className="topic-subtitle-tp">toki pona li pona</span>
          )}
          {topic.slug === "spanish" && (
            <span className="topic-subtitle-spanish">Vamos a aprender</span>
          )}
          {topic.slug === "soroban" && (
            <span className="topic-subtitle-soroban">そろばん</span>
          )}
